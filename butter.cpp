...
/**********************************************************************
    Writen by Charles.
    Simply calculate just the same as the function
...
int main()
{
    ...
    //These two vectors are only for calculating filtfilt function in another repository
